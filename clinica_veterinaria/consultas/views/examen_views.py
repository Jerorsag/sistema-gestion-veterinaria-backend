...
- GET /api/examenes/{id}/ - Ver detalle
- POST /api/examenes/ - Crear examen individual
...
from clinica_veterinaria.consultas.models import Examen
from clinica_veterinaria.consultas.serializers.examen_serializers import ExamenSerializer, ExamenCreateSerializer
...
class ExamenViewSet(viewsets.ModelViewSet):
    ...
    pero este ViewSet permite gestionarlos individualmente.
    """
