...
from clinica_veterinaria.consultas.patterns.composite import HistoriaClinicaCompuesta, ConsultaHoja
from clinica_veterinaria.consultas.patterns.builder import HistoriaClinicaBuilder
