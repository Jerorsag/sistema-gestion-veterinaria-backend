...
# Reusable prefix for API v1 routes to avoid duplicated literals
...
urlpatterns = [
    ...
    # API v1
    path(API_V1_PREFIX, include('usuarios.urls')),
    path(API_V1_PREFIX, include('mascotas.urls')),
    path(API_V1_PREFIX, include('consultas.urls')),
    path(API_V1_PREFIX, include('inventario.urls')),
    path(API_V1_PREFIX, include('citas.urls')),
    path(API_V1_PREFIX, include('transacciones.urls')),
